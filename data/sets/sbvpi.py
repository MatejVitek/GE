...
class SBVPI(Dataset, sample_cls = SBVPISample):
	@classmethod
	def from_dir(cls, dir, mask_dir='', *args, extra_info_path=Path('/data/SBVPI.txt'), **kw):
	...
	@classmethod
	def read_extra_info(cls, extra_info_path=Path('/data/SBVPI.txt')):
